"""Full chaos verification of the Cassiopea attractor.
...
Writes results/cassiopea_verification.json.
"""
...
from cassiopea.dynamics import A, B, G, LAM, MU, NU, W_ROT, divergence, trajectory
from cassiopea.equilibria import classify, find_equilibria
from cassiopea.lyapunov import kaplan_yorke_dimension, lyapunov_spectrum
...
def main():
    ...
    out = ROOT / "results" / "cassiopea_verification.json"
