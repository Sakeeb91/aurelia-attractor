"""Lyapunov spectrum and Kaplan-Yorke dimension of the Cassiopea attractor.

Standard Benettin tangent-space method: an orthonormal frame is advected by
the linearized flow and re-orthonormalized by QR at every step.
"""
...
from .dynamics import (
    A, B, G, LAM, MU, NU, W_ROT, DEFAULT_STATE, jacobian, rk4_step, velocity,
)
...
def lyapunov_spectrum(n_steps=400_000, dt=0.005, transient=20_000, state0=DEFAULT_STATE,
